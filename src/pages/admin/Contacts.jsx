...
export default function Contacts() {
  ...
  const fetchContacts = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://viadocs-backend-production.up.railway.app/api/admin/contacts");
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(
        `https://viadocs-backend-production.up.railway.app/api/admin/contacts/${deleteTarget._id}`,
        { method: "DELETE" }
      );
      const data = await res.json();
