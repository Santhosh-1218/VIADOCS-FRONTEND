...
export default function Feedbacks() {
  ...
  const fetchFeedbacks = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://viadocs-backend-production.up.railway.app/api/admin/feedbacks");
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(
        `https://viadocs-backend-production.up.railway.app/api/admin/feedbacks/${deleteTarget._id}`,
        {
          method: "DELETE",
        }
      );
